...
public class BingHandler {
     ...
     * @throws IOException 
     */
        public List<Article> getArticles(String query, DataModel data){
        	System.out.println("i'm querying for: " + query);
                ...
                for (int i = 0; iter.hasNext(); i++) {
                    ...
                    if(content != null && content != "" && !content.isEmpty()){
                    	...
                    	content = "\n" + content;
                         ...
                         ArrayList<String> terms = localParser.parseString(content);
...
//                         }
                         ...
                         for (String s : terms) {
                             ...
                             if (data.hasEntity(s)) {
                                 ...
                                 e = data.getEntity(s);
                                 //fireEntityChange(e, 0, DataListener.ADDEDNOTE);
                             } else {
    ...
    public String getBingJson(String query)    {
        ...
        URL url;
        try {
        	url = new URL("https://api.datamarket.azure.com/Bing/Search/News?Query=%27" + query + "%27&$top=50&$format=json");
        	
        	//url = new URL("https://api.datamarket.azure.com/Bing/Search/Web?Query=%27" + query + "%27&$top=50&$format=json");
