...
public class StarSpireApp extends JFrame implements ComponentListener {
    ...
    private Action projectSource;
    private Action projectSourceoff;
    ...
    private void initFileMenu() {
        ...
        projectSource = new AbstractAction("Turn Bing On") {
        	public void actionPerformed(ActionEvent e) {
        		currentProject.setBing(true);
        	}
        };
        JMenuItem sourceItem = new JMenuItem(projectSource);
        setAccelerator(sourceItem, KeyEvent.VK_B);
        fileMenu.add(sourceItem);
        
        projectSourceoff = new AbstractAction("Turn Bing Off") {
        	public void actionPerformed(ActionEvent e) {
        		currentProject.setBing(false);
        	}
        };
        JMenuItem sourceOffItem = new JMenuItem(projectSourceoff);
        setAccelerator(sourceOffItem, KeyEvent.VK_V);
        fileMenu.add(sourceOffItem);
